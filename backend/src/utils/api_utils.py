...
from .serialization import serialize_agent_state  # 維持

# ロガーをインポート
try:
    # log_agent_executionはここでは不要
    from .llm_interaction_logger import set_global_log_storage  # 維持
...
def log_llm_interaction(state):
    ...
    def decorator(llm_func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if not agent_name:
                try:
                    from .llm_interaction_logger import current_agent_name_context, current_run_id_context
